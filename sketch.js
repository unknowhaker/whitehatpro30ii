...
function setup() {
    ...
    ub1 = new Box(850,275,50,50);
    ub2 = new Box(900,275,50,50);
    ub3 = new Box(950,275,50,50);
    ub4 = new Box(1000,275,50,50);
    ub5 = new Box(1050,275,50,50);
    ub6 = new Box(1100,275,50,50);
    ub7 = new Box(1150,275,50,50);
    ub8 = new Box(900,223,50,50);
    ub9 = new Box(950,223,50,50);
    ub10 = new Box(1000,223,50,50);
    ub11 = new Box(1050,223,50,50);
    ub12 = new Box(1100,223,50,50);
    ub13 = new Box(950,170,50,50);
    ub14 = new Box(1000,170,50,50);
    ub15 = new Box(1050,170,50,50);
    ub16 = new Box(1000,120,50,50);
